...
const socials = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
        <path d="M2 6.5A2.5 2.5 0 0 1 4.5 4h15A2.5 2.5 0 0 1 22 6.5v11A2.5 2.5 0 0 1 19.5 20h-15A2.5 2.5 0 0 1 2 17.5v-11Zm2.5-.5a.5.5 0 0 0-.5.5v.62l8 4.67 8-4.67V6.5a.5.5 0 0 0-.5-.5h-15ZM20 9.43l-7.24 4.22a1.5 1.5 0 0 1-1.52 0L4 9.43v8.07a.5.5 0 0 0 .5.5h15a.5.5 0 0 0 .5-.5V9.43Z" />
      </svg>
    ),
  },
];
