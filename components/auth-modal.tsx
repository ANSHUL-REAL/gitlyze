...
export function AuthStatusButton({
  ...
  if (user) {
    return (
      <button
        ...
        className="hidden h-10 min-w-[92px] items-center justify-center gap-2 whitespace-nowrap rounded-full border border-border bg-panel/80 px-4 text-sm text-muted-foreground sm:inline-flex"
      >
  ...
  return (
    <button
      type="button"
      onClick={onOpen}
      className="inline-flex h-10 min-w-[92px] items-center justify-center gap-2 whitespace-nowrap rounded-full border border-border bg-panel/80 px-4 text-sm text-muted-foreground"
    >
